...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        resized_img = resized_img[:, :3750]  # Adjusting the shape to match the expected input
        print("Shape of resized_img:", resized_img.shape)  # This should print (1, 3750) if the model expects 3750 features
